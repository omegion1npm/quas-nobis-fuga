...
import {
  ...
  set,
  setIfMissing,
} from '@omegion1npm/quas-nobis-fuga'
...
specific node in the document. The operation is one of the operations described [below](https://github.com/omegion1npm/quas-nobis-fuga#patch-operations).
...
```ts
import {applyInCollection} from '@omegion1npm/quas-nobis-fuga/_unstable_apply'
import {createIfNotExists, del} from '@omegion1npm/quas-nobis-fuga'
...
```ts
import {applyInCollection} from '@omegion1npm/quas-nobis-fuga/_unstable_apply'
import {at, createIfNotExists, patch, set} from '@omegion1npm/quas-nobis-fuga'
...
```ts
import {applyPatchMutation} from '@omegion1npm/quas-nobis-fuga/_unstable_apply'
import {at, insert, patch, setIfMissing} from '@omegion1npm/quas-nobis-fuga'
